...
<h1 style="padding: 1rem;">Bienvenido: Categorías-Nuevo registro</h1>
                        ...
                        {!!Form::open(['route'=>'category.store', 'method' =>'post', 'entype' => 'multipart/form-data'])!!}
                            <div class="card-body">
                                <div class="form-group">
                                    {!!Form::UTTextOnly('name', 'Nombre de la Categoria', 'Nombre del usuario', null, $errors, 40, true )!!}
                                </div>
                                <div class="form-group">
                                    {!!Form::UTTextOnly('descripcion', 'Descripción', 'Descripción', null, $errors, 40, true )!!}
                                </div>
                                <!-- <div class="form-group">
